...
export const PDFPropertiesPanel = ({
  ...
  return (
    <aside className="w-72 glass-panel rounded-xl p-4 border border-gray-800/80 bg-gray-900/60 flex flex-col shrink-0 overflow-hidden select-none space-y-4">
      ...
      <div className="flex-1 overflow-y-auto space-y-4 pr-1 custom-scrollbar text-xs">
        ...
        {/* TAB 2: EDITING & CONTEXTUAL TEXT FORMATTING */}
        {activeTab === 'tools' && (
          <div className="space-y-4">
            {/* CONTEXTUAL TEXT PROPERTIES (Shown when a text box is selected) */}
            {selectedTextObj ? (
              <div className="p-3.5 rounded-xl bg-blue-500/10 border border-blue-500/30 space-y-3">
                <div className="flex items-center justify-between font-semibold text-blue-300">
                  <span className="flex items-center gap-1.5">
                    ...
                    <span>Selected Text Properties</span>
                  </span>
                  <button
